---
name: aarrr-analyzer
description: Use when analyzing funnels, diagnosing growth problems, reviewing pirate metrics, or asking "where is our funnel breaking."
---
...
1. Map current metrics at each stage: Acquisition → Activation → Retention → Revenue → Referral
2. Identify the biggest drop-off (bottleneck)
3. Diagnose root cause
4. Prioritize: Fix activation before scaling acquisition
