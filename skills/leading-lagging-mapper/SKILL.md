...
description: Use when connecting metrics, understanding indicator relationships, building metric chains, or asking "what predicts this outcome."
---
...
1. Identify lagging outcomes (business results you care about)
2. Hypothesize leading indicators (activities/behaviors that predict outcomes)
3. Validate relationships with data
4. Define the chain: Leading → Intermediate → Lagging
