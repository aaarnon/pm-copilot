...
description: Use when choosing KPIs, defining success metrics, evaluating which metrics to track, or asking "what should we measure."
---
...
3. Apply 5 lenses: Actionable, Accessible, Auditable, Aligned, Appropriate
4. Check for traps: vanity metrics, lagging-only, proxy gaming, too many
