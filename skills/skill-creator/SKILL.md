---
name: skill-creator
description: Use when building new skills, creating SKILL.md files, or setting up skill structure.
---
...
1. Write description FIRST: "Use when [triggers]..." in third person
2. Name: lowercase-with-hyphens, prefer gerund form (-ing)
3. Keep SKILL.md under 500 lines, link out for heavy reference
4. Test: "If I said [X], would this skill activate?"
...
**Good description:**
```yaml
description: Use when processing interview notes, creating interview summaries, or extracting customer insights from conversations.
```

**Bad description:**
```yaml
description: Synthesizes customer interview notes into one-page summaries with quotes, experience maps, and opportunities.
```

The bad example summarizes what the skill does. This causes Claude to shortcut and follow the description instead of reading the full skill content.
...
| Good | Bad |
|------|-----|
| "Use when working with Excel files or spreadsheets" | "I can help you process Excel files" |
| "Use when synthesizing interview notes" | "You can use this to summarize interviews" |
