...
description: Use when organizing discovery findings, structuring opportunities, deciding which problem to solve, or building an OST.
---
...
1. Define the desired outcome (business/product goal)
2. List opportunities in customer language (needs, not features)
3. Prioritize opportunities by impact, confidence, and strategic fit
4. Remember: Prioritize opportunities first, then explore solutions
