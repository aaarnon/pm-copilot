...
description: Use when building impact models, creating driver trees, connecting metrics to business goals, or visualizing metric relationships.
---
...
1. Identify North Star metric (business success measure)
2. Break into 2-4 major drivers
3. Map leading indicators teams can influence to each driver
4. Assign ownership and set targets
