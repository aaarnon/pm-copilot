...
| [OS Discovery Playbook](https://docs.google.com/document/d/1NJN5yc-yuIPHBNLlgFq3x2BanX179OQeJr3ZSrEM-rw/) | `alignment/os-discovery-playbook-cutler.md` | Org Operating System Discovery, Cycles/Rituals/Artifacts, Noun Farming, Intent Graph, 10-Chapter Playbook | `org-discovery` `operating-model` `cycles` `rituals` `artifacts` `org-structure` | John Cutler | Stakeholder, Strategy, initiative-alignment-doc |
